USING: tools.test syntax sequences regexp accessors ;
...
USE: classes
 ...
 B{ 131 104 4 100 0 4 98 101 114 116 100 0 5 114 101 103 101 120 106 106 } bert>  raw>> .
! [ "" ] [ B{ 131 104 4 100 0 4 98 101 114 116 100 0 5 114 101 103 101 120 106 106 } bert> raw>> ] unit-test
